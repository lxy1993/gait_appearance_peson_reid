...
class Mars(object):
    ...
    ######CASIA_split################
    track_train_info_path = osp.join(root, 'info_v2/train_info.npy')
    track_test_info_path = osp.join(root, 'info_v2/test_info.npy')
    query_IDX_path = osp.join(root, 'info_v2/query_IDX_cl.npy')
    ...
    def __init__(self, min_seq_len=0):
        ...
        # query_IDX -= 1 # index from 0  ####matlab 文件的下标师从1开始的
    ...
    def _process_data(self, names, meta_data, home_dir=None, relabel=False, min_seq_len=0):
        ...
        for tracklet_idx in range(num_tracklets):
            ...
            #####删减版的数据集#######
            seq = {"1": "bg-01", "2": "bg-02", "3": "cl-01", "4": "cl-02", "5": "nm-01", "6": "nm-02", "7": "nm-05", "8": "nm-06"}
            ...
            # seq = {"1":"bg-01", "2":"bg-02", "3":"cl-01", "4":"cl-02","5": "nm-01", "6": "nm-02", "7":"nm-03", "8":"nm-04",
            #        "9":"nm-05","10":"nm-06"}
